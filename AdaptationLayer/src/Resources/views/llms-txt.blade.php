...
- Adres: Duaçınarı Mah. 1. Özgünay Sk No:10, Yıldırım / Bursa (posta kodu 16270)
- Instagram: https://instagram.com/asefsondajj
- YouTube: https://www.youtube.com/@asefsondaj
...
- **Sektör derinliği**: Maden sondajı, jeotermal sondaj, su sondajı, jeoteknik zemin etütleri, kaya delgi — hepsinde birebir tecrübe.

## Uzmanlık Alanları ve Hizmet Verdiğimiz Sektörler

**Maden Sondajı**
Karot alma odaklı jeoloji ve maden arama operasyonları için wireline karotiyer sistemleri (BWL, HQ, NQ, PQ), düz takım karotiyer, emprenye elmas ve vidye karot bit'leri, komple karot alma ekipmanları, karot sandıkları ve numune alıcılar.

**Jeotermal ve Su Sondajı**
Derin kuyu sondajı için rotary ekipman, sondaj tijleri (API IF/API REG/DCDMA standartları), muhafaza boruları, kompresör bağlantıları, çamur pompası çözümleri, sondaj kimyasalları. DSİ izin süreçlerinde teknik dokümantasyon desteği.
...
## Ürün Kategorileri (15 Ana Kategori)

1. **Wireline Karotiyer Sistemi (WLS)** — 277+ ürün. BWL, HQ, NQ, PQ standartları
2. **Düz Takım Karotiyer Sistemi (DTK)** — 76+ ürün
3. **Elmas ve Vidye Ürünler (ELM)** — 148+ ürün. Emprenye elmas ve vidye karot bit
4. **Tijler ve Muhafaza Boruları (TIJ)** — 49+ ürün. API IF, API REG, DCDMA standartları
5. **Aksesuarlar (AKS)** — 33+ ürün
...
13. **Jeoteknik Ekipmanlar (JEO)** — 12+ ürün
14. **Güvenlik Ekipmanları (GUV)** — 10+ ürün
15. **Sondaj Makineleri (MKN)** — yakında

## Hizmetlerimiz

- **Ürün Tedariki**: 900+ ürün stok — karotiyer, karot bit, tij, muhafaza borusu, adaptör, aksesuar, kaya delgi, kimyasal, sarf malzemeleri
...
- [Sondaj Ekipmanları Kataloğu](https://www.asefsondaj.com/urunler): Tüm ürünler, kategoriye göre filtrelenebilir
- [Wireline Karotiyer Sistemi](https://www.asefsondaj.com/urunler/wireline-karotiyer-sistemi): 277+ wireline karotiyer modeli, BWL/HQ/NQ/PQ
- [Düz Takım Karotiyer Sistemi](https://www.asefsondaj.com/urunler/duz-takim-karotiyer-sistemi): 76+ düz takım karotiyer modeli
- [Elmas ve Vidye Ürünler](https://www.asefsondaj.com/urunler/elmas-ve-vidye-urunler): 148+ emprenye elmas ve vidye karot bit
- [Sondaj Tijleri ve Muhafaza Boruları](https://www.asefsondaj.com/urunler/tijler-ve-muhafaza-borulari): API IF, API REG, DCDMA
- [Aksesuarlar](https://www.asefsondaj.com/urunler/aksesuarlar)
...
- [Jeoteknik Ekipmanlar](https://www.asefsondaj.com/urunler/jeoteknik-ekipmanlar)
- [Güvenlik Ekipmanları](https://www.asefsondaj.com/urunler/guvenlik-ekipmanlari)

## Kurumsal Sayfalar

- [Ana Sayfa](https://www.asefsondaj.com/)
- [Hakkımızda](https://www.asefsondaj.com/hakkimizda): 20+ yıllık saha tecrübesi, ekip, firma hikayesi
...
- [İletişim](https://www.asefsondaj.com/iletisim): Adres, telefon, iletişim formu
- [Destek Merkezi](https://www.asefsondaj.com/destek): Teknik yardım, garanti
...
- [Sondaj Operasyonlarında Ekipman Seçimi](https://www.asefsondaj.com/blog/ekipman-secim-rehberi): Kapsamlı rehber
...
- [Su Sondajı DSİ İzin Süreci](https://www.asefsondaj.com/blog/su-sondaji-mevzuat): Yasal rehber
...
- [SSS - Sıkça Sorulan Sorular](https://www.asefsondaj.com/sss): 20+ soru, sondaj sektöründe sık sorulan konular
- [Sondaj Sözlüğü](https://www.asefsondaj.com/sondaj-sozlugu): 60+ sektör terimi ile Türkçe sondaj terminoloji sözlüğü
...
**Yoğun hizmet verdiğimiz iller (örnek)**: Bursa, İstanbul, Ankara, İzmir, Konya, Antalya, Adana, Gaziantep, Kayseri, Muğla, Denizli, Manisa, Balıkesir, Trabzon, Samsun, Zonguldak, Kocaeli, Sakarya, Tekirdağ, Eskişehir.
