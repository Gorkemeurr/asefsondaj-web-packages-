<x-admin::layouts>
    ...
    <div class="flex items-center justify-between gap-4 mb-6">
        <div>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-300 mt-1">
                Sitede kullanılan iletişim bilgileri, WhatsApp mesajı, hero başlık ve footer metni.
            </p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.asef.settings.update') }}" method="POST" class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6 max-w-3xl space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="pt-4 border-t border-gray-200 dark:border-gray-800">
            <button type="submit" class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium">Ayarları Kaydet</button>
        </div>
    </form>
</x-admin::layouts>
