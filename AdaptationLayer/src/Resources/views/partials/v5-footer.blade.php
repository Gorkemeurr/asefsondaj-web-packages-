    ...
    <div class="asef-container">
        <div class="asef-footer-grid">
            ...
            <div class="asef-footer-brand">
                ...
                <p>{{ asef_setting('footer_intro', "20 yıllık saha tecrübesiyle Türkiye'nin dört bir yanındaki sondaj operasyonlarına ekipman, yedek parça ve teknik danışmanlık.") }}</p>
                <div class="asef-footer-social" style="display:flex; gap:10px; margin-top:20px;">
                    <a href="{{ asef_setting('instagram_url', 'https://instagram.com/asefsondajj') }}" target="_blank" rel="noopener" aria-label="Instagram"
                    ...
                    <a href="tel:{{ preg_replace('/[^0-9+]/', '', asef_setting('iletisim_telefon', '+90 532 054 29 75')) }}" aria-label="Telefon"
                       style="width:36px;height:36px;border-radius:8px;display:inline-flex;align-items:center;justify-content:center;background:#F5F5F7;color:#1a1c1d;">
                        <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                    </a>
                    <a href="mailto:{{ asef_setting('iletisim_email', 'iletisim@asefsondaj.com') }}" aria-label="E-posta"
                       style="width:36px;height:36px;border-radius:8px;display:inline-flex;align-items:center;justify-content:center;background:#F5F5F7;color:#1a1c1d;">
            ...
            <div class="asef-footer-col">
                ...
                <ul>
                    ...
                    @foreach ($footAnaAll->take(6) as $_a)
                        <li><a href="{{ ($_a->slug ?? null) ? url('urunler/' . $_a->slug) : $catalogUrl . '?ana=' . $_a->code }}">{{ $_a->name }}</a></li>
                    @endforeach
            ...
            <div class="asef-footer-col">
                ...
                <ul>
                    ...
                    <li><a href="{{ $waLink }}" target="_blank" rel="noopener">{{ asef_setting('iletisim_telefon', '+90 532 054 29 75') }}</a></li>
                    <li><a href="mailto:{{ asef_setting('iletisim_email', 'iletisim@asefsondaj.com') }}">{{ asef_setting('iletisim_email', 'iletisim@asefsondaj.com') }}</a></li>
                    <li><a href="mailto:{{ asef_setting('iletisim_email_destek', 'destek@asefsondaj.com') }}">{{ asef_setting('iletisim_email_destek', 'destek@asefsondaj.com') }}</a></li>
                    <li style="color: var(--gray-secondary); line-height: 1.5; margin-top: 6px;">{!! nl2br(e(asef_setting('iletisim_adres', 'Duaçınarı Mah. 1. Özgünay Sk No:10, Yıldırım / Bursa'))) !!}</li>
                </ul>
            </div>
        </div>
